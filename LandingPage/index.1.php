...
<img max-width="100%" height="" src="http://i.imgur.com/xybufXH.png" alt="Outbreak Community">
</a>
            </div>
			...
			<li>
				<a href="http://join-ob.com/forums">Forums</a>
			</li>
                    <li>
		    ...
		    <li>
                    ...
                    <li>
                        <a href="http://www.outbreak-community.com/Donate/" target="_blank">Donate <i class="fa fa-external-link"></i></a>
                    </li>
...
<div class="container">
		...
		<iframe style="max-width:100%;min-height:100%;border: 6px solid #191918;" width="1155" height="650" src="https://www.youtube.com/embed/vz2rAgXjkCA?playlist=vz2rAgXjkCA&amp;rel=0&amp;loop=1&amp;modestbranding=1&amp;hd=1&amp;showinfo=0&amp;controls=0&amp;iv_load_policy=3&amp;wmode=transparent&amp;autohide=1&amp;autoplay=1&amp;disablekb=1&amp;fs=0&amp;html5=1&amp;enablejsapi=1" frameborder="0" allowfullscreen>
...
<!--<iframe style="max-width:100%;min-height:100%;" width="100%" height="550" src="https://www.youtube-nocookie.com/embed/rGOHB7RuvT8?start=6&amp;rel=0&amp;autoplay=1&amp;controls=0&amp;showinfo=0&amp;loop=1&amp;iv_load_policy=3&amp;enablejsapi=1" frameborder="0" allowfullscreen></iframe>-->
    <!-- Services Section -->
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <h4>Jailbreak</h4>
                        <p class="text-muted">jb.join-ob.com </p>
                        <?php echo 'test'; ?>
...
<!--steam://connect/jb.join-ob.com-->
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/team/1.jpg" class="img-responsive img-circle" alt="">
                        <h4>Teamspeak</h4>
                        <p class="text-muted">ts.join-ob.com</p>
...
<!--steam://connect/jb.join-ob.com-->
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <p class="large text-muted">We specialise in providing a fun community atmosphere and great player experience when on our servers as we believe you should enjoy playing on the server with the players as well as your favourite game mode. 

If CS:GO isn't your thing, don't worry! Our community has a very diversed player-base who actively play other games such as League of Legends, GTA V, Minecraft and more in our dedicated Teamspeak rooms.</p>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>2009-2011</h4>
                                    <h4 class="subheading">History of OB</h4>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        ...
                        <p class="text-muted">View all of our models & player items!</p>
                    </div>
                </div>
            </div>
        </div>
...
<li><span style="color:#E94618;">Design:</span> <a href="http://www.outbreak-community.com/forums/index.php?/profile/3082-gunstar/"><span style="color:#E94618;">Gunstar</span></a>
                       </li>
