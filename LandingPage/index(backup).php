    ...
    <section id="services" class="bg-light-gray">
  	...
  	<button class="buttonc" onclick="window.location = 'steam://connect/jb.join-ob.com'"><span>Join </span></button>
                ...
                <div class="col-sm-6">
                    <div class="team-member">
                        <div class="image">
                        <img src="img/team/ts3.png" class="img-responsive " alt="">
                        <div class="sSquare"></div> <!-- status background -->
            			<ul class="dot">
  	...
  	<button class="buttonc" onclick="window.location = 'steam://connect/surf.join-ob.com'"><span>Join </span></button>-->
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <p class="large text-muted">We specialise in providing a fun atmosphere and great player experience on our servers as we believe you should enjoy playing on the server with the players as well as your favourite game mode. 

If CS:GO isn't your thing, don't worry! Our community has a very diversed player-base who actively play other games such as League of Legends, GTA V, Minecraft and many more!</p>
                </div>
            </div>
        </div>
    </section>
